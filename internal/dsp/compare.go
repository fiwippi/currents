...
func PrettyClose(a, b []float32) bool {
	if len(a) != len(b) {
		return false
	}
...
func PrettyCloseC(a, b []complex64) bool {
	if len(a) != len(b) {
		return false
	}
...
func PrettyClose2(a, b [][]complex64) bool {
	if len(a) != len(b) {
		return false
	}
...
func PrettyClose2F(a, b [][]float32) bool {
	if len(a) != len(b) {
		return false
	}
...
func Float64Equal(a, b float32) bool {
	return math.Abs(float64(a)-float64(b)) <= closeFactor || math.Abs(1-float64(a)/float64(b)) <= closeFactor
}
